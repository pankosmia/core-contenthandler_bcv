...
function TsvExport() {
    ...
    const tsvExportOneBook = async bookCode => {
        ...
        let blob = new Blob([bookTsvResponse.text], { type: "text/tab-separated-values" });
    ...
    return (
        ...
        <Box>
            ...
            <PanDialog
                titleLabel={doI18n("pages:core-contenthandler_text_translation:export_as_tsv", i18nRef.current)}
                closeFn={() => handleClose()}
                isOpen={open}
                theme={theme}
                fullWidth={false}
                ...
                <PanDialogActions
                    ...
                    actionFn={() => {
                        if (!selectedBooks || selectedBooks.length === 0) {
                            ...
                            selectedBooks.forEach(tsvExportOneBook);
                        }
                        handleCloseCreate();
                    }}
